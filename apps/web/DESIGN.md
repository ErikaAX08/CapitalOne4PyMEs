---
version: alpha
name: Resilia · Suit Sans Pro + Capital One For PyMES
description: Vercel-inspired spacing and materials adapted to Capital One For PyMES, with Suit Sans Pro for headings. Capital One blue (#004878) drives primary actions and information, while Capital One red (#D22E1E) is reserved for brand emphasis and focused visual accents.
...
colors:
  ...
  pink: "#ff0080"
  magenta: "#eb367f"
  gradient-develop-start: "#004878"
  gradient-develop-end: "#2a7fa8"
  gradient-preview-start: "#356f93"
  gradient-preview-end: "#d22e1e"
  gradient-ship-start: "#d22e1e"
  gradient-ship-end: "#e79087"

typography:
  display-xl:
    fontFamily: Suit Sans Pro, Geist, Arial, sans-serif
    fontSize: 48px
    fontWeight: 400
    lineHeight: 48px
    letterSpacing: -2.4px
...
> **Project color override:** Resilia keeps the Geist component geometry and
> typography documented below, but replaces Vercel's black primary and legacy
> rainbow accents with Capital One blue (`#004878`) and red (`#D22E1E`). Primary
> application buttons use blue; red is a supporting brand accent and is not the
> sole signal for financial status.

> **Project typography and effects override:** Headings use the bundled Suit
> Sans Pro ExtraLight face for both standard and bold/semibold treatments,
> without synthesized bold. Body text and technical labels remain Geist. The
> Resilia landing intentionally omits the reference mesh gradient and decorative
> backdrop blur, and all standard buttons use the tighter 6px radius instead of
> marketing pills.
